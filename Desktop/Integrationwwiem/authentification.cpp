    ...
    ui(new Ui::authentification)
{
    ...
    this->setWindowTitle("Connexion");
      ...
      QPixmap pix("C:/Users/Zakraoui/Downloads/balsem/gestion_accuser/dif.jpg");
  ui->label22->setPixmap(pix);

  QPixmap pix2("C:/Users/Zakraoui/Desktop/Integrationwwiem/court (3).png");
ui->label_logo1->setPixmap(pix2);
