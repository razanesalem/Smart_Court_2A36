...
public:     //méthodes de la classe Arduino
    ...
    void setarduino_port_name( const QString &s){arduino_port_name=s;};
    /*void setcurrentBaudRate(qint32 s){currentBaudRate=s;};
    qint32 getcurrentBaudRate(){return currentBaudRate;};*/
