...
affaire_inter::affaire_inter(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::affaire_inter)
{
    ui->setupUi(this);
    Affaire A;
...
affaire_inter::~affaire_inter()
{
    delete ui;
}

void affaire_inter::on_pushButton_clicked()   //ajout //+controle archive
{
...
if(found==0)
{
    ...
    void affaire_inter::on_pushButton_2_clicked()  //supp
    {
...
void affaire_inter::on_pushButton_3_clicked()   //modif
{
...
void affaire_inter::on_radioButtontridate_clicked()
{
    ui->tableView->setModel(A.trie());
}

void affaire_inter::on_pushButtontri_clicked()
{
 ui->tableView->setModel(A.afficher());
}
...
//----------------------------------------------------------------------------pdf
void affaire_inter::on_PDF_clicked()
{
    QPdfWriter pdf("C:/Users/ACER/Documents/affaires.pdf");
            ...
            {
                QDesktopServices::openUrl(QUrl::fromLocalFile("C:/Users/ACER/Documents/affaires.pdf"));
...
void affaire_inter::on_pushButton_archiver_raz_clicked()
{
...
void affaire_inter::on_stat_raz_clicked()
{
...
//----------------------------------------------------desearchivage
void affaire_inter::on_desearchive_raz_clicked()
{
...
//--------------------------------------------------------qrcode
void affaire_inter::on_pushButton_4_clicked()
{
    QMessageBox msgBox;
...
void affaire_inter::on_lineEdit_textChanged(const QString &arg1)
{
...
void affaire_inter::on_portStatusButton_clicked()
{
...
void affaire_inter::on_disconnectButton_clicked()
{
    a.getserial()->clear();
    a.getserial()->close();
...
void affaire_inter::on_connectButton_clicked()
{
...
void affaire_inter::on_envoyertexte_clicked()
{
...
void affaire_inter::on_supprimertexte_clicked()
{
     ui->messageTextEdit->clear();
}

void affaire_inter::on_clearLCDButton_clicked()
...
void affaire_inter::on_fontsizeSpinBox_valueChanged(int arg1)
{
      ui->messageTextEdit->setFontPointSize(arg1);
}

void affaire_inter::readArduino(){
